...
public class MyThread extends Thread {
    ...
    public MyThread(String nameThread, int precision, int numThread, BigInteger firstTerm, BigInteger lastTerm, boolean quiet) {
    ...
    public void run() {
        ...
        //System.out.println("calc fistTerm num = " + numerator.toString());
        Apfloat denominator;
        ...
        //System.out.println("calc fistTerm den = " + denominator.toString() + " - " + factorial(firstTerm.multiply(BigInteger.valueOf(2))));
        //System.out.println("0 - " + numerator.divide(denominator).toString());
        ...
        for (BigInteger t = firstTerm.add(BigInteger.ONE); t.compareTo(lastTerm) < 0; t = t.add(BigInteger.ONE)) {
            ...
            //System.out.println(t + " = " + numerator.toString() + "/" + denominator.toString() + " = " + numerator.divide(denominator).toString());
            sum = sum.add(numerator.divide(denominator));
        }
